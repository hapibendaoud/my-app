...
return(
    <div className="bg-white items-center flex justify-between w-full h-20 px-10 shadow-lg fixed top-0 z-40">
        ...
        <div className=" flex justify-around gap-8 h-full items-center w-33.33%">
            <Link href={"/"}><div className="cursor-pointer text-gray-700 py-7"><TextBorderAnimation text="Home" className={`${isActive("/") ? "text-blue-600 font-bold" : "text-gray-700"}`}/></div></Link>
            <Link href={"/about"}><div className="cursor-pointer text-gray-700 py-7"><TextBorderAnimation text="About" className={`${isActive("/about") ? "text-blue-600 font-bold" : "text-gray-700"}`}/></div></Link>
            <Link href={"/services"}><div className="cursor-pointer text-gray-700 py-7"><TextBorderAnimation text="Services" className={`${isActive("/services") ? "text-blue-600 font-bold" : "text-gray-700"}`}/></div></Link>
            <Link href={"/contact"}><div className="cursor-pointer text-gray-700 py-7"><TextBorderAnimation text="Contact" className={`${isActive("/contact") ? "text-blue-600 font-bold" : "text-gray-700"}`}  /></div></Link>
        </div>
